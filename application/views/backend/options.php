...
<div class="container header">
        <div class="pull-left">
          <h1 class="page_title_text">Options</h1>
        </div>
      </div>
    ...
    <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Layout / Colors</a></li>
    <li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">Slider</a></li>
    <li role="presentation"><a href="#settings" aria-controls="settings" role="tab" data-toggle="tab">Advertising</a></li>
    <li role="users"><a href="#users" aria-controls="users" role="tab" data-toggle="tab">Users</a></li>
    <li role="posts"><a href="#posts" aria-controls="posts" role="tab" data-toggle="tab">Posts</a></li>
    <li role="mail"><a href="#mail" aria-controls="settings" role="tab" data-toggle="tab">Mail</a></li>
    <li role="social"><a href="#social" aria-controls="social" role="tab" data-toggle="tab">Social</a></li>
    <li role="footer"><a href="#footer" aria-controls="footer" role="tab" data-toggle="tab">Footer</a></li>
    <li role="import"><a href="#import" aria-controls="import" role="tab" data-toggle="tab">Import</a></li>
    <li role="newsletter"><a href="#newsletter" aria-controls="newsletter" role="tab" data-toggle="tab">Newsletter</a></li>
  </ul>
