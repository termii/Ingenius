...
<div class="container maincontent" id="pagecontent">
                        ...
                        <form id="formregisto" action="" method="post">    
                            ...
                            <div class="row" style="margin-top:10px;">
                                    ...
                                    <div class="col-sm-4">                                    
                                        ...
                                        <strong><a href="<?php echo base_url();?>user/points">Points:</a></strong> <?php echo $this->stories_model->num_upvotes($use['user_id'])*$this->option_model->get_value('appuserranklike')-$this->stories_model->num_downvotes($use['user_id'])*$this->option_model->get_value('appuserranklike'); ?>, joined <?php echo date("Y-m-d", strtotime($use['user_date'])); ?><br />
                                        <?php } ?><br />
    ...
    <ul class="nav nav-tabs tabs-up" id="profiletabs">
      ...
      <li><a href="<?php echo base_url();?>stories/followers2/<?php echo $id; ?>" data-target="#followers" class="media_node span" id="friends_list_tab" data-toggle="tabajax" rel="tooltip"><?php echo $this->lang->line('followers'); ?> <span><?php echo $num_followers; ?></span></a></li>
      <li><a href="<?php echo base_url();?>stories/following2/<?php echo $id; ?>" data-target="#following" class="media_node span" id="awaiting_request_tab" data-toggle="tabajax" rel="tooltip"><?php echo $this->lang->line('following'); ?> <span><?php echo $num_following; ?></span></a></li>
      <li><a href="<?php echo base_url();?>stories/favourites2/<?php echo $id; ?>" data-target="#favourites" class="media_node span" id="favourites_tab" data-toggle="tabajax" rel="tooltip"><?php echo $this->lang->line('favourites'); ?> <span><?php echo $num_favourites; ?></span></a></li>
    </ul>
