                    ...
                    <li>
                      ...
                      <div class="row">
                        <section class="col-sm-12 col-md-12">
                          ...
                          <br />
                        <div class="row">  
                        <div class="story-vote-inside col-md-1">
                          ...
                          <article class="story-title col-md-11" style="margin-bottom:20px;padding-left:0;">
                          
                          <?php if (($sto['post_by'] == $this->session->userdata('userid')) && ($sto['post_type'] != "poll")) { ?>                            
                            <a href="<?php echo base_url(); ?>stories/edit/<?php echo $sto['post_slug']; ?>" style="float:right;cursor:hand;padding:4px 8px;font-size:11px;" class="btn btn-danger btn-sm editbtn" data-id="<?php echo $sto['post_id']; ?>">Edit post</a>                            
                            <?php } ?>
                          ...
                          <h2 style="clear:both;padding-top:10px;font-size: 38px;line-height: 45px;color:#000000;font-family:Montserrat;padding-bottom: 10px;">
                          ...
                          <?php } } else { ?>                        
                          <div style="width:100%;background-color:#f8f8f8;margin-bottom:20px;margin-top:5px;">
                          ...
                          <div style="float:right;">
                              <?php $tagss = $this->stories_model->get_tags_by_id($sto['post_id']); ?>
                              <?php if (count($tagss)>0): ?>
                              <?php foreach($tagss as $tag): ?>
                                <a href="<?php echo base_url(); ?>stories/tag/<?php echo $tag['tag_slug']; ?>"><span style="border: 1px solid #5fcf80;color:#5fcf80;border-radius: 100px;padding: 2px 10px;font-size: 12px;"><?php echo $tag['tag_name']; ?></span></a>
                              <?php endforeach; ?>
                              <?php endif; ?>
                          </div>  
                          ...
                          <div  class="row meta">
                           ...
                           <?php
                            ...
                            <?php if (trim($sto['favourite']) != "") { ?>
                                  <a href="javascript:void(0);" class="btnfav btnfavouriterem" data-id="<?php echo $sto['post_id']; ?>"><i class="fa fa-star"></i>&nbsp;&nbsp;<?php echo $this->lang->line('favouriteicon'); ?></a> 
                            <?php } else { ?>
                                  <a href="javascript:void(0);" class="btnfav btnfavourite" data-id="<?php echo $sto['post_id']; ?>"><i class="fa fa-star-o"></i>&nbsp;&nbsp;<?php echo $this->lang->line('favouriteicon'); ?></a> 
                            <?php } ?>   
                            <?php } ?>
                            ...
                            &nbsp;&nbsp;
                            <?php if($this->session->userdata('logged_in')) { ?>
                            <a href="javascript:void(0);" data-toggle="modal" data-target="#reportmodal" class="btnreport" data-id="<?php echo $sto['post_id']; ?>">
                            <?php } else { ?>
                            <a href="javascript:void(0);" data-toggle="modal" data-target="#loginmodal" class="btnreport" data-id="<?php echo $sto['post_id']; ?>">
                            <?php } ?>
                            <i class="fa fa-exclamation"></i>&nbsp;&nbsp;<?php echo $this->lang->line('reportcontent_btn'); ?>
                            </a> 
                            ...
                            <div id="socialpost" class="col-md-5" style="text-align: right;">

                                <a href="https://twitter.com/intent/tweet?text=<?php echo $new; ?>&url=<?php echo base_url(); ?>stories/article/<?php echo $sto['post_slug']; ?>" title="Share on Twitter" target="_blank" class="btn btn-sharetwitter"><i class="fa fa-twitter"></i></a>                                  
                                <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo base_url(); ?>stories/article/<?php echo $sto['post_slug']; ?>" title="Share on Facebook" target="_blank" class="btn btn-sharefacebook"><i class="fa fa-facebook"></i></a>
                                <a href="https://plus.google.com/share?url=<?php echo base_url(); ?>stories/article/<?php echo $sto['post_slug']; ?>" title="Share on Google+" target="_blank" class="btn btn-sharegoogleplus"><i class="fa fa-google-plus"></i></a>
                                <a href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo base_url(); ?>stories/article/<?php echo $sto['post_slug']; ?>&title=&summary=" title="Share on LinkedIn" target="_blank" class="btn btn-sharelinkedin"><i class="fa fa-linkedin"></i></a>
...
group by polls_options.option_id");
                    ...
                    <div style="padding: 0px 20px 0px 30px;float:left;clear:both;width:100%;">
