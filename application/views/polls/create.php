		...
		<?php echo form_open('polls/create', array('class' => 'adpt_inputs_form')); ?>		
		<div id="pollarea">
        ...
        <div class="append-icon row" style="margin-top:10px;background-color:#f8f8f8;border-radius:10px;padding:10px 30px;">                                
                                ...
                                <div class="append-icon row" style="margin-top:10px;background-color:#f8f8f8;border-radius:10px;padding:10px 30px;">                                
                                    ...
                                    <input type="text" name="postimage" id="postimage" class="form-control form-white" placeholder="Image full url" required="" rows="6" />                                
                                </div>
...
<link rel="stylesheet" href="<?php echo base_url(); ?>ckeditor/toolbarconfigurator/lib/codemirror/neo.css">
		...
		$(function(){
			...
			$("#pollsend-image").click(function(){
		            ...
		            jQuery('#pollarea > #fileloading').show();
		            ...
		            jQuery.ajax({
		                ...
		                success: function(data)
		                {
		                    jQuery('#pollarea > #fileloading').hide();
		                    jQuery("#pollarea > #"+data.result).html(data.message).slideDown();                    
